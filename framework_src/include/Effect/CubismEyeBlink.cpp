...
namespace Live2D {
    namespace Cubism {
        namespace Framework {
            ...
            csmFloat32& CubismEyeBlink::GetBlinkingIntervalSeconds()
            {
                return _blinkingIntervalSeconds;
            }

            csmFloat32& CubismEyeBlink::GetClosingSeconds()
            {
                return _closingSeconds;
            }

            csmFloat32& CubismEyeBlink::GetClosedSeconds()
            {
                return _closedSeconds;
            }

            csmFloat32& CubismEyeBlink::GetOpeningSeconds()
            {
                return _openingSeconds;
            }
            ...
            Csm::csmVector<Csm::CubismIdHandle>& CubismEyeBlink::GetParameterIds()
            {
