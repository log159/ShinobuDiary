...
Su::JoinGuiMark(key, sizeof(key), ::inimark_map[::INIMARK::KEY], ct->name);\
Su::JoinGuiMark(appid, sizeof(appid), ::inimark_map[::INIMARK::APPID], ct->name);\
Su::JoinGuiMark(secret, sizeof(secret), ::inimark_map[::INIMARK::SECRET], ct->name);\
Su::JoinGuiMark(baseurl, sizeof(baseurl), ::inimark_map[::INIMARK::BASEURL], ct->name);\
...
Su::JoinGuiMark(address, sizeof(address), ::inimark_map[::INIMARK::ADDRESS], ct->name);\
Su::JoinGuiMark(port, sizeof(port), ::inimark_map[::INIMARK::PORT], ct->name);\
