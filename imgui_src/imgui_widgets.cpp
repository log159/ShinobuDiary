...
void ImGui::TextLinkOpenURL(const char* label, const char* url)
{
    ...
    SetItemTooltip(/*LocalizeGetMsg(ImGuiLocKey_OpenLink_s)*/TT_222, url); // It is more reassuring for user to _always_ display URL when we same as label
