...
namespace ImGui
{
    ...
    IMGUI_API bool          SliderAngle(const char* label, float* v_rad, float v_degrees_min = -360.0f, float v_degrees_max = +360.0f, const char* format = NULL, ImGuiSliderFlags flags = 0);
