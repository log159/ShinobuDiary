    ...
    */
    if (ImGui::BeginCombo(label,::GlobalConfig::getInstance()->select_font.c_str()))
    {
        for (ImFont* font : io.Fonts->Fonts)
        {
            ...
            if (ImGui::Selectable(font->GetDebugName(), font == font_current)) {
                io.FontDefault = font;
                ::GlobalConfig::getInstance()->select_font = std::string(font->GetDebugName());
                std::cout << u8"字体设置为 " << ::GlobalConfig::getInstance()->select_font << std::endl;
            }
            ImGui::PopID();
        }
        ImGui::EndCombo();
...
void ImGui::ShowStyleEditor(ImGuiStyle* ref)
{
    ...
    { bool border = (style.WindowBorderSize > 0.0f); if (ImGui::Checkbox(TT_46, &border)) { style.WindowBorderSize = border ? 1.0f : 0.0f; } }
    ImGui::SameLine();
    { bool border = (style.FrameBorderSize > 0.0f);  if (ImGui::Checkbox(TT_47,  &border)) { style.FrameBorderSize  = border ? 1.0f : 0.0f; } }
    ImGui::SameLine();
    ...
    {
        if (ImGui::BeginTabItem(TT_51))
        {
            ImGui::SeparatorText(TT_52);
            ImGui::SliderFloat2(TT_53, (float*)&style.WindowPadding, 0.0f, 20.0f, "%.0f");
            ImGui::SliderFloat2(TT_54, (float*)&style.FramePadding, 0.0f, 20.0f, "%.0f");
            ImGui::SliderFloat2(TT_55, (float*)&style.ItemSpacing, 0.0f, 20.0f, "%.0f");
            ImGui::SliderFloat2(TT_56, (float*)&style.ItemInnerSpacing, 0.0f, 20.0f, "%.0f");
            ImGui::SliderFloat2(TT_57, (float*)&style.TouchExtraPadding, 0.0f, 10.0f, "%.0f");
            ImGui::SliderFloat(TT_58, &style.IndentSpacing, 0.0f, 30.0f, "%.0f");
            ImGui::SliderFloat(TT_59, &style.ScrollbarSize, 1.0f, 20.0f, "%.0f");
            ImGui::SliderFloat(TT_60, &style.GrabMinSize, 1.0f, 20.0f, "%.0f");

            ImGui::SeparatorText(TT_61);
            ImGui::SliderFloat(TT_62, &style.WindowBorderSize, 0.0f, 1.0f, "%.0f");
            ImGui::SliderFloat(TT_63, &style.ChildBorderSize, 0.0f, 1.0f, "%.0f");
            ImGui::SliderFloat(TT_64, &style.PopupBorderSize, 0.0f, 1.0f, "%.0f");
            ImGui::SliderFloat(TT_65, &style.FrameBorderSize, 0.0f, 1.0f, "%.0f");
            ImGui::SliderFloat(TT_66, &style.TabBorderSize, 0.0f, 1.0f, "%.0f");
            ImGui::SliderFloat(TT_67, &style.TabBarBorderSize, 0.0f, 2.0f, "%.0f");
            ImGui::SliderFloat(TT_68, &style.TabBarOverlineSize, 0.0f, 2.0f, "%.0f");
            //ImGui::SameLine(); 
            ...
            ImGui::SliderFloat(TT_76, &style.GrabRounding, 0.0f, 12.0f, "%.0f");
            ImGui::SliderFloat(TT_77, &style.TabRounding, 0.0f, 12.0f, "%.0f");

            ImGui::SeparatorText(TT_78);
            ImGui::SliderFloat2(TT_79, (float*)&style.CellPadding, 0.0f, 20.0f, "%.0f");
            ImGui::SliderAngle(TT_80, &style.TableAngledHeadersAngle, -50.0f, +50.0f);
            ImGui::SliderFloat2(TT_81, (float*)&style.TableAngledHeadersTextAlign, 0.0f, 1.0f, "%.2f");

            ImGui::SeparatorText(TT_82);
            ImGui::SliderFloat2(TT_83, (float*)&style.WindowTitleAlign, 0.0f, 1.0f, "%.2f");
            int window_menu_button_position = style.WindowMenuButtonPosition + 1;
            if (ImGui::Combo(TT_84, (int*)&window_menu_button_position, TT_85))
                style.WindowMenuButtonPosition = (ImGuiDir)(window_menu_button_position - 1);
            ImGui::Combo(TT_132, (int*)&style.ColorButtonPosition, TT_133);
            ImGui::SliderFloat2(TT_86, (float*)&style.ButtonTextAlign, 0.0f, 1.0f, "%.2f");
            ImGui::SameLine(); HelpMarker(TT_87);
            ImGui::SliderFloat2(TT_88, (float*)&style.SelectableTextAlign, 0.0f, 1.0f, "%.2f");
            ImGui::SameLine(); 
            HelpMarker(TT_89);
            ImGui::SliderFloat(TT_90, &style.SeparatorTextBorderSize, 0.0f, 10.0f, "%.0f");
            ImGui::SliderFloat2(TT_91, (float*)&style.SeparatorTextAlign, 0.0f, 1.0f, "%.2f");
            ImGui::SliderFloat2(TT_92, (float*)&style.SeparatorTextPadding, 0.0f, 40.0f, "%.0f");
            ImGui::SliderFloat(TT_93, &style.LogSliderDeadzone, 0.0f, 12.0f, "%.0f");

            ImGui::SeparatorText(TT_94);
            ImGui::SliderFloat(TT_95, &style.DockingSeparatorSize, 0.0f, 12.0f, "%.0f");

            ImGui::SeparatorText(TT_96);
            for (int n = 0; n < 2; n++)
                if (ImGui::TreeNodeEx(n == 0 ? TT_97 : TT_98))
                {
                    ImGuiHoveredFlags* p = (n == 0) ? &style.HoverFlagsForTooltipMouse : &style.HoverFlagsForTooltipNav;
                    ImGui::CheckboxFlags(TT_99, p, ImGuiHoveredFlags_DelayNone);
                    ImGui::CheckboxFlags(TT_100, p, ImGuiHoveredFlags_DelayShort);
                    ImGui::CheckboxFlags(TT_101, p, ImGuiHoveredFlags_DelayNormal);
                    ImGui::CheckboxFlags(TT_102, p, ImGuiHoveredFlags_Stationary);
                    ImGui::CheckboxFlags(TT_103, p, ImGuiHoveredFlags_NoSharedDelay);
                    ImGui::TreePop();
                }

            ImGui::SeparatorText(TT_104);
            ImGui::SliderFloat2(TT_105, (float*)&style.DisplayWindowPadding, 0.0f, 30.0f, "%.0f"); ImGui::SameLine(); HelpMarker(TT_134);
            ImGui::SliderFloat2(TT_106, (float*)&style.DisplaySafeAreaPadding, 0.0f, 30.0f, "%.0f"); ImGui::SameLine(); HelpMarker(TT_135);
        ...
        if (ImGui::BeginTabItem(TT_107))
        {
            ...
            for (int i = 0; i < ImGuiCol_COUNT; i++)
            {
                ...
                if (memcmp(&style.Colors[i], &ref->Colors[i], sizeof(ImVec4)) != 0)
                {
                    ...
                    ImGui::SameLine(0.0f, style.ItemInnerSpacing.x); if (ImGui::Button(TT_117)) { ref->Colors[i] = style.Colors[i]; }
                    ImGui::SameLine(0.0f, style.ItemInnerSpacing.x); if (ImGui::Button(TT_118)) { style.Colors[i] = ref->Colors[i]; }
                }
        ...
        if (ImGui::BeginTabItem(TT_119))
        {
            ...
            ImGui::DragFloat(TT_121, &io.FontGlobalScale, 0.005f, MIN_SCALE, MAX_SCALE, "%.2f", ImGuiSliderFlags_AlwaysClamp); // Scale everything
            ImGui::PopItemWidth();

            ImGui::EndTabItem();
        }

        if (ImGui::BeginTabItem(TT_122))
        {
            ImGui::Checkbox(TT_123, &style.AntiAliasedLines);
            ImGui::SameLine();
            HelpMarker(TT_195);

            ImGui::Checkbox(TT_124, &style.AntiAliasedLinesUseTex);
            ImGui::SameLine();
            HelpMarker(TT_196);

            ImGui::Checkbox(TT_125, &style.AntiAliasedFill);
            ImGui::PushItemWidth(ImGui::GetFontSize() * 8);
            ImGui::DragFloat(TT_126, &style.CurveTessellationTol, 0.02f, 0.10f, 10.0f, "%.2f");
            if (style.CurveTessellationTol < 0.10f) style.CurveTessellationTol = 0.10f;

            // When editing the "Circle Segment Max Error" value, draw a preview of its effect on auto-tessellated circles.
            ImGui::DragFloat(TT_127, &style.CircleTessellationMaxError , 0.005f, 0.10f, 5.0f, "%.2f", ImGuiSliderFlags_AlwaysClamp);
            const bool show_samples = ImGui::IsItemActive();
            if (show_samples)
                ImGui::SetNextWindowPos(ImGui::GetCursorScreenPos());
            if (show_samples && ImGui::BeginTooltip())
            {
                ImGui::TextUnformatted(TT_197);
                ImGui::Spacing();
                ImDrawList* draw_list = ImGui::GetWindowDrawList();
            ...
            ImGui::DragFloat(TT_129, &style.Alpha, 0.005f, 0.20f, 1.0f, "%.2f"); // Not exposing zero here so user doesn't "lose" the UI (zero alpha clips all widgets). But application code could have a toggle to switch between zero and non-zero.
            ImGui::DragFloat(TT_130, &style.DisabledAlpha, 0.005f, 0.0f, 1.0f, "%.2f");
            ImGui::SameLine(); 
            HelpMarker(TT_131);
            ImGui::PopItemWidth();
